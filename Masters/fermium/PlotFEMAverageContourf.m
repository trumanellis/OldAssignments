function [h,returnpts,returnvals]=PlotFEMAverageContourf(nodes,projvector,ptmapping,varmapping,npts,ptBasis,varBasis,varargin)
...
for N=1:NZ
    for i=1:nl
        ...
        globalvals(i)=LocalToGlobal(projvector(varmapping(:,N)),localpts(:,i),varBasis,N);
	end
	meanval=mean(globalvals);
